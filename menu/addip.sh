...
CYAN='\e[36m'
LIGHT='\033[0;37m'
tokengit=$(curl -sS https://raw.githubusercontent.com/isohmaohot/drgvpnscript/main/access.conf)
MYIP=$(wget -qO- ipinfo.io/ip);
adminip=$( curl -sS https://raw.githubusercontent.com/isohmaohot/allow/main/accessmenu | grep $MYIP )
...
sleep 1
cek=$( curl -sS https://raw.githubusercontent.com/isohmaohot/allow/main/ipvps.conf | awk '{print $5}' | grep $daftar )
if [[ $daftar = $cek ]]; then
...
rm -rf /root/allow
git config --global user.email "sarahlaurel713@gmail.com"
git config --global user.name "isohmaohot"
git clone https://github.com/isohmaohot/allow.git
mkdir /root/allow
cd /root/allow/
rm -rf .git
git init
...
links3="sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/cakill26/drgvpnscript/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh"
clear

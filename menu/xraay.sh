...
echo -e "‼️Aktivitas Berikut Adalah Dilarang (ID anda akan di ban tanpa notis & tiada refund)"
...
echo -e "‼️Aktivitas Berikut Adalah Dilarang (ID anda akan di ban tanpa pengecualian & tdak ada refund)"
echo -e "\e[31m❌ Torrent (p2p, streaming p2p)"
echo -e "\e[31m❌ PS4"
echo -e "\e[31m❌ Porn"
echo -e "\e[31m❌ Spam Bug"
